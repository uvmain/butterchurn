export default class ImageTextures {
  ...
  samplers: { [key: string]: WebGLTexture }
  ...
  constructor(gl: WebGLRenderingContext) {
    ...
    this.clouds2Image.onload = () => {
      ...
      this.bindTexture(this.samplers.clouds2, this.clouds2Image)
    }
    ...
    this.emptyImage.onload = () => {
      ...
      this.bindTexture(this.samplers.empty, this.emptyImage)
    }
    this.emptyImage.src
      = 'data:image/gif;base64,R0lGODlhAQABAIAAAAUEBAAAACwAAAAAAQABAAACAkQBADs='
  }

  bindTexture(texture: WebGLTexture, data: TexImageSource) {
    ...
    Object.keys(imageData).forEach((imageName) => {
      ...
      if (!this.samplers[imageName]) {
        ...
        image.onload = () => {
          ...
          this.bindTexture(this.samplers[imageName], image)
        }
        image.src = data
      }
    })
  ...
  getTexture(sampler: string): WebGLTexture {
